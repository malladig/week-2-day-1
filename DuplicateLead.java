...
WebDriverManager.chromedriver().setup();
	    ...
	    chd.findElement(By.linkText("Duplicate Lead")).click();
	    WebElement cn1=chd.findElement(By.id("createLeadForm_companyName"));
	    cn1.clear();
	    cn1.sendKeys("Test ABC");
	    WebElement fn1=chd.findElement(By.id("createLeadForm_firstName"));
	    fn1.clear();
	    fn1.sendKeys("Gayamal");
